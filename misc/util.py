...
def toRed(content): return termcolor.colored(content,"grey",attrs=["bold"])
def toGreen(content): return termcolor.colored(content,"grey",attrs=["bold"])
def toBlue(content): return termcolor.colored(content,"grey",attrs=["bold"])
def toCyan(content): return termcolor.colored(content,"grey",attrs=["bold"])
def toYellow(content): return termcolor.colored(content,"grey",attrs=["bold"])
def toMagenta(content): return termcolor.colored(content,"grey",attrs=["bold"])
